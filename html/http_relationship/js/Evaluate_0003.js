...
function getDebuggerProcess(target) {
	...
	process:[
	    ...
	    }, evaluate:function(){if(target["dragdrop1"] == "input4"){return true;}else{return false;}},feedback:"feedback/exercise03/post_req_error.html"},
	    ...
	    }, evaluate:function(){if(target["dragdrop3"] == "input3"){return true;}else{return false;}},feedback:"feedback/exercise03/sql_condition_error.html"},
